    ...
    def parse_lawyer_page(self, response):
        ...
        try:
            ...
            if practice_areas[-1] == 'More\xa0':
                practice_areas.pop()
            practice_areas_dict = dict([tuple(practice_area.split(':\xa0')) for practice_area in practice_areas])
        ...
        # year of license
        try:
            item["license"] = response.xpath("//time[@data-timestamp='years-active']/text()").extract_first()
        except ValueError:
            item["license"] = ""
        ...
        try:
            ...
            payment_types = response.xpath("//*[@id='payments']/div/div/div/div/div/div[2]/p/small/text()").extract_first()
